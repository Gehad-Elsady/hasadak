...
import 'package:hasadak/Screens/Home/engineers/model/eng_model.dart';
...
import 'package:hasadak/notifications/model/notification_model.dart';
...
class FirebaseFunctions {
  ...
  //----------------manage my server----------------
  static Stream<List<ServiceModel>> getMyServices(String type, String userId) {
    final FirebaseFirestore _firestore = FirebaseFirestore.instance;
